  ...
  if (usage === "inbox") {
    process.stdout.write(
      [
        ...
        "",
        "create --with-key also mints an inbox-scoped API key and returns",
        "{ inbox, apiKey }. Run it with a pod-scoped key: the inbox lands in that",
        "pod, and apiKey.token can only read/send from that inbox. The token is",
        ...
        "",
        "Examples:",
        "  openmail inbox create --display-name \"Research agent\" --with-key --json",
